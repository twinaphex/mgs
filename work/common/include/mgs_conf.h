#ifndef INC_MGS_CONF_H
#define INC_MGS_CONF_H
...
#define WIN32_INTEGRAL  BUILD_WIN32_INTEGRAL// Aug.28,2000 :: MGS_Work___Win32_Integral
#define WIN32_VRONLY    BUILD_WIN32_VRONLY  // Aug.28,2000 :: MGS_Work___Win32_VrOnly
#define WIN32_DEMO0     BUILD_WIN32_DEMO0   // Oct.04,2000 :: MGS_Work___Win32_Demo0

/* --- METAL GEAR SOLID 4 (PSX MODULE) --- */

#define PSX_MGS4_FR     BUILD_PSX_MGS4_FR   // Nov.28,2007 :: USRDIR/mgs/stage/module/fr.self
#define PSX_MGS4_GR     BUILD_PSX_MGS4_GR   // Nov.28,2007 :: USRDIR/mgs/stage/module/gr.self
#define PSX_MGS4_IT     BUILD_PSX_MGS4_IT   // Nov.28,2007 :: USRDIR/mgs/stage/module/it.self
#define PSX_MGS4_JP     BUILD_PSX_MGS4_JP   // Nov.28,2007 :: USRDIR/mgs/stage/module/jp.self
#define PSX_MGS4_SP     BUILD_PSX_MGS4_SP   // Nov.28,2007 :: USRDIR/mgs/stage/module/sp.self
#define PSX_MGS4_US     BUILD_PSX_MGS4_US   // Nov.28,2007 :: USRDIR/mgs/stage/module/us.self

/*---------------------------------------------------------------------------*
 * Additional Checks & Defines
 *---------------------------------------------------------------------------*/

/* Common Flag for PSX USA */
#if defined( BUILD_SLUS00594_v10 )\
||  defined( BUILD_SLUS00594_v11 )
#define PSX_USA 1
#endif

/* Common Flag for PSX PAL Spanish */
#if defined( BUILD_SLES01734_v10 )\
||  defined( BUILD_SLES01734_v11 )
#define PSX_PAL_SP 1
#endif
