#ifndef INC_BUILDDEFS_H_PSX
#define INC_BUILDDEFS_H_PSX

/*
 *  A build flag must be defined in order to properly compile the project.
 *  ONLY ONE configuration may be defined at a time.
 *
 *  Example:
 *    -DBUILD_SLPS12345
 */
...
/* PILOT DISC */
#define MGS_DEMO_PILOT1 BUILD_SLPM80254 // Apr.27,1998 PILOT DISC
#define MGS_DEMO_JPN    BUILD_SLPM86098 // Jun.18,1998 JPN DEMO
#define MGS_DEMO_PILOT2 BUILD_PAPX90044 // Jun.30,1998 PILOT DISC
...
#error "Build flag collision!!"
     ...
     + BUILD_MGS4_SP \
     + BUILD_MGS4_US )
#error "No build flag was defined!!"
#endif

#endif // INC_BUILDDEFS_H_PSX